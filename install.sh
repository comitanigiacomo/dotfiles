...
echo -e "Installazione (Metodo Copia Manuale) ---"
...
echo -e "Fase 3: Post-Installazione e Permessi ---"
...
# 3.4. Ricostruisce la cache dei font (FC-CACHE)
...
echo -e "\Installazione completata! Verificare l'ambiente:"
